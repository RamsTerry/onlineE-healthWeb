...
<body
	style="background-image: url(images/back.jpg); background-size: 1370px;">
	...
	<div class="container-fluid">
		...
		<div class="container">
			...
			<!--  Login Form  -->
			<h2 style='color: white;'><b>Register Here</b></h2>
			...
			<div class='col-sm-3 col-md-6 col-lg-4' style='color: red;'>
				The email address you entered is already exist.<br> Please
				enter a different email.<br>
			</div>
			...
			<form class="form-inline" method="post" name="RegistForm" action=""
				...
				<div class="checkbox">
					<label><input type="radio" name="category" id="category"
						...
						<font color="white">User</font> </label> &nbsp;&nbsp;
		<!--<label><input type="radio" name="category" id="category" value="CSR" onClick="javascript:openUser('none');"> <font color="white">CSR Employee</font> </label>  -->
				...
				<div class="form-group">
					<label for="focusedInput"><font color="white">Email :</font> </label><br> <input
						...
						color="red">* it should be your account</font></i>
				</div>
				<br>
				<div class="form-group">
				...
				<div id="custInfo">
					...
					<div class="form-group">
						<label for="focusedInput"><font color="white">City :</font> </label><br> <input
							class="form-control" type="text" id="city" size="50"
			...
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Register up</h4>
					</div>
