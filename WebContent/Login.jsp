			...
			<form class="form-inline" method="post" name="LoginForm" action=""
				...
				<div class="checkbox">
					<label><input type="radio" name="userType" id="userType"
						value="csr"> <font color="white"><strong>Admin</strong></font> </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio"
						name="userType" id="userType" checked value="user"><font color="white"><strong>User</strong></font></label>
				</div>
				<br>
				<br>
				...
				<button type="submit" class="btn btn-warning active"
					onclick="javascript:location.href='Register.jsp';">Go to
					Register</button>
			</form>
		</div>
