				 	...
				 	<table border=0>
				  		<tr>
				  			<td width="100px">${status.count} .&nbsp;&nbsp;&nbsp;
				  				<img src="images/ehealth.jpg" width="50px" class="img-thumbnail" alt="Cinque Terre">
				  		 
				  			</td> 
				  			<td align="right" width="50px"> <b>Title</b> ${orders.itemName} </td>&nbsp;
				  			
				  			<td align="right" width="100px">|Price: <b><fmt:formatNumber value="${orders.price }" type="currency" /></b></td>&nbsp;
				  			<td align="right" width="50px"> |<b>Qnty:</b> ${orders.quantity} </td>
				  			
				  			<td align="right" width="100px"><strong>Add:</strong>
				  			...
				  			<td align="right" width="100px">Status: <font color="red"> ${orders.orderStatus}</font> </td>
