...
public class CustomersDAO {
	...
	public Customer searchCustomer(String customerId) throws Exception {
		...
		// make a query
		String selectQuery = "select userName, userPwd, firstname, lastname, address, city, postalcode from Customers where customerId='"
				+ customerId + "'";
	...
	public void updateRow(String customerId, String address, String city, String postalCode) throws Exception {
		...
		// make a query
		String updateQuery = "Update customers " + "set address =?, city =?, postalCode =? " + "where customerId = ?";
	...
	//
	// UPDATE : update address, city, postalcode info
	public void updateRow(String customerId, String customerPwd, String firstName, String lastName, String address,
			String city, String postalCode) throws Exception {
