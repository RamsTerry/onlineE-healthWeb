...
public class CartDAO {
	...
	public void addRow( int itemId, String itemName, String customerId, String numberofmedicine, int quantity, double price)throws Exception {
 
		
		// make a query
        String insertQuery = "Insert into cart (itemId,itemName,customerId,numberofmedicine,quantity,price) "
        		+ "values (?,?,?,?,?,?)";
        ...
        try{
			...
			pst.setString(4, numberofmedicine);
	...
	public ArrayList<Cart> listCart(String customerId) throws Exception{
		...
		// make a query
		String selectQuery = "select cartNo, itemId, itemName, numberofmedicine, quantity, price from Cart where customerId ='" + customerId + "' ";
		         ...
		         while(rs.next())
		  		 {
		        	 ...
		        	 cart.setNumberofmedicine(rs.getString(4));
