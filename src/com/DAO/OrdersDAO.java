...
public class OrdersDAO {
	...
	public void orderAllItems(String customerId) throws Exception {
		...
		// make a query
		String selectQuery = "select itemId, numberofmedicine, quantity, price from Cart where customerId ='" + customerId
				+ "' order by cartNo asc";
		...
		try {
			...
			try {
				...
				while (rs.next()) {
					...
					// insert order
					String insertQuery = "Insert into Orders (itemId,customerId,numberofmedicine, quantity,price,orderStatus,Orderdate) "
	...
	public ArrayList<Orders> listAllOrders() throws Exception {
		...
		// make a query
		String selectQuery = "select o.orderID, o.itemId, o.customerId, o.numberofmedicine, o.quantity, o.price, o.orderStatus, o.Orderdate, m.itemName "
				+ " from Orders o, Medicines m " + " where o.itemId = m.itemId " + " order by o.orderId asc";
		...
		try {
			...
			try {
				...
				while (rs.next()) {
					...
					order.setNumberofmedicine(rs.getString(4));
	...
	public ArrayList<Orders> listOrders(String customerId) throws Exception {
		...
		// make a query
		String selectQuery = "select o.orderID, o.itemId, o.customerId, o.numberofmedicine, o.quantity, o.price, o.orderStatus, o.Orderdate, m.itemName "
				+ " from Orders o, Medicines m " + " where o.customerId ='" + customerId + "' and o.itemId = m.itemId "
	...
	public ArrayList<Orders> listOrdersPlaced(String customerId) throws Exception {
		...
		// make a query
		String selectQuery = "select o.orderID, o.itemId, o.customerId, o.shoesize, o.quantity, o.price, o.orderStatus, o.Orderdate, m.itemName "
				+ " from Orders o, Medicines m " + " where o.customerId ='" + customerId
				+ "' and o.orderStatus = 'Order Placed' and o.itemId = m.itemId " + " order by o.orderId asc";
